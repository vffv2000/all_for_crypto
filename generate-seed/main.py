...
sheet.column_dimensions['A'].width = 66
sheet.column_dimensions['B'].width = 44
sheet.column_dimensions['C'].width = 66
if input(
        "Скрипт может сгенерировать seed фразы, а может взять уже готовые из файла mnemonic.txt . Сгенерировать новые seed фразы? (y/n): ") == "y":
    # Number of wallets
